...
const LeftPanelNavigation = (props: {
  ...
  return (
    <>
      ...
      <div className={`absolute h-full duration-300 z-30 bg-white dark:bg-black-2 text-black dark:text-white transition-all overflow-hidden  ${props.isOpenMenu ? 'w-5/6' : 'w-0'} shadow-2xl`}>
